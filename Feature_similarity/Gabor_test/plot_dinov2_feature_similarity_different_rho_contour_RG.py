...
for backbone_index in range(len(backbone_name_list)):
    ...
    title_name_list = [f'{backbone_name} - L1 similarity - final feature - RG',
                       f'{backbone_name} - L2 similarity - final feature - RG',
                       f'{backbone_name} - cos similarity - final feature - RG',
                       f'{backbone_name} - L1 similarity - intermediate feature - RG',
                       f'{backbone_name} - L2 similarity - intermediate feature - RG',
                       f'{backbone_name} - cos similarity - intermediate feature - RG']
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig(os.path.join(save_root_path, f'dinov2_ppd_{ppd}_{backbone_name}_contour_plot_RG'))
    X = 1
